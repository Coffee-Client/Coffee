...
import cf.coffee.client.feature.gui.hud.HudRenderer;
...
import cf.coffee.client.mixin.IDebugHudAccessor;
import cf.coffee.client.mixin.IInGameHudAccessor;
...
public class Hud extends Module {
    ...
    public void onHudRender() {
        ...
        if (CoffeeMain.client.options.debugEnabled) {
            ...
            List<String> lt = ((IDebugHudAccessor) ((IInGameHudAccessor) CoffeeMain.client.inGameHud).getDebugHud()).callGetLeftText();
            List<String> rt = ((IDebugHudAccessor) ((IInGameHudAccessor) CoffeeMain.client.inGameHud).getDebugHud()).callGetRightText();
