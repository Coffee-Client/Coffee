...
public class BooleanSettingEditor extends SettingEditor<BooleanSetting> {
    ...
    public void render(MatrixStack stack, double mouseX, double mouseY) {
        ...
        Renderer.R2D.renderRoundedQuad(stack, Renderer.Util.lerp(new Color(50, 50, 50), new Color(2, 2, 2), d), getPositionX() + getWidth() - bruhWidth, getPositionY() + getHeight() / 2d - bruhHeight, getPositionX() + getWidth(), getPositionY() + getHeight() / 2d + bruhHeight, bruhHeight, 15);
