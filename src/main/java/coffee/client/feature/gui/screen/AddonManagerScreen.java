...
public class AddonManagerScreen extends ClientScreen implements FastTickable {
    ...
    class AddonViewer implements FastTickable {
        ...
        public void render(MatrixStack stack, double x, double y, int mouseX, int mouseY) {
            ...
            Renderer.R2D.renderRoundedQuadInternal(stack.peek().getPositionMatrix(), background.getRed() / 255f, background.getGreen() / 255f,
                    background.getBlue() / 255f, 1, x + padding, y + padding, x + padding + iconDimensions, y + padding + iconDimensions, 6, 10);
            ...
            Renderer.R2D.renderTexture(stack, x + padding, y + padding, iconDimensions, iconDimensions, 0, 0, iconDimensions, iconDimensions, iconDimensions,
                    iconDimensions);
            ...
            if (addon.isEnabled()) {
                title.drawString(stack, addon.name, (float) (x + padding + iconDimensions + padding), (float) (y + getHeight() / 2d - entireHeight / 2d),
                        0xFFFFFF);
            } else {
                title.drawString(stack, addon.name, (float) (x + padding + iconDimensions + padding), (float) (y + getHeight() / 2d - entireHeight / 2d), 0.6f,
                        0.6f, 0.6f, 1f);
            }
