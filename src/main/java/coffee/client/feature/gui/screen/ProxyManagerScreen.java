...
public class ProxyManagerScreen extends CenterOverlayScreen {
    ...
    protected void initInternal() {
        ...
        TextElement mode = new TextElement(FontRenderers.getRenderer(), "Type: " + (isSocks4 ? "SOCKS4" : "SOCKS5"), Color.WHITE, false, 0,
                0);
        ...
        ButtonGroupElement bg = new ButtonGroupElement(0, 0, entireWidth, 20, ButtonGroupElement.LayoutDirection.RIGHT,
        ...
        FlexLayoutElement entire = new FlexLayoutElement(FlexLayoutElement.LayoutDirection.DOWN, 0, 0, padding, mode, conn, top, middle,
                bg);
        addChild(entire);
    }
