...
public class CenterOverlayScreen extends AAScreen {
    ...
    public void renderInternal(MatrixStack stack, int mouseX, int mouseY, float delta) {
        ...
        Renderer.R2D.renderRoundedQuadWithShadow(stack, new Color(20, 20, 20), centerX - elementWidth / 2d - padding,
                centerY - elementHeight / 2d - padding, centerX + elementWidth / 2d + padding, centerY + elementHeight / 2d + padding, 5,
                20);
