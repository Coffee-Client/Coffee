...
public class Plague extends Item {
    ...
    public ItemStack generate() {
        ...
        NbtGroup ng = new NbtGroup(new NbtList("Enchantments", new NbtObject("", new NbtProperty("id", "minecraft:protection"), new NbtProperty("lvl", (short) 1))),
                new NbtObject("EntityTag", new NbtProperty("Duration", duration.getValue() * 20),
                        ...
                        new NbtProperty("Particle", "barrier"), new NbtProperty("Radius", 1.0f), new NbtProperty("RadiusPerTick", spread.getValue()), new NbtProperty("ReapplicationDelay", 0),
