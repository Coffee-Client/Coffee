...
public class AimAssist extends Module {
    ...
    final BooleanSetting aimInstant = this.config.create(
            new BooleanSetting.Builder(false).name("Aim instantly").description("Whether or not to aim instantly instead of smoothly").get());
    Entity le;
