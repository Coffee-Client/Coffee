...
public class Timer extends Module {
    ...
    final DoubleSetting newTps = this.config.create(
            new DoubleSetting.Builder(20).name("New TPS").description("To what to set the new tps to").min(0.1).max(100).precision(1).get());
