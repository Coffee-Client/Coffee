...
public class FreeLook extends Module {
    ...
    @Getter
    final BooleanSetting enableAA = this.config.create(
            new BooleanSetting.Builder(false).name("Enable Anti-Aim").description("Hvh toggle rage nn noob").get());
    final EnumSetting<AntiAimMode> aaMode = this.config.create(
            new EnumSetting.Builder<>(AntiAimMode.Spin).name("AA Mode").description("How to aim").get());
