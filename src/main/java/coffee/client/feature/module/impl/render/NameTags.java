...
public class NameTags extends Module {
    ...
    void drawInternal(Vec3d screenPos, String text, AbstractClientPlayerEntity entity) {
        ...
        Renderer.R2D.renderRoundedQuad(stack1, new Color(0, 0, 5, 100), actual.x - width / 2d, actual.y, actual.x + width / 2d,
                actual.y + labelHeight, 3, 20);
        nameDrawer.drawString(stack1, text, actual.x + width / 2d - nameDrawer.getStringWidth(text) - 2, actual.y + 2, 0xFFFFFF);

        infoDrawer.drawString(stack1, gmString, actual.x + width / 2d - infoDrawer.getStringWidth(gmString) - 2,
        ...
        Renderer.R2D.renderRoundedQuad(stack1, new Color(60, 60, 60, 255), actual.x - width / 2d + 2,
                actual.y + labelHeight - 2 - healthHeight, actual.x + width / 2d - 2, actual.y + labelHeight - 2, healthHeight / 2d, 10);
        ...
        Renderer.R2D.renderRoundedQuad(stack1, MID_END, actual.x - width / 2d + 2, actual.y + labelHeight - 2 - healthHeight, drawTo,
                actual.y + labelHeight - 2, healthHeight / 2d, 10);
    }
