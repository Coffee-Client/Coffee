...
public class MSAAFramebuffer extends Framebuffer {
    ...
    public static void use(int samples, Framebuffer mainBuffer, Runnable drawAction) {
        ...
        GlStateManager._glBlitFrameBuffer(0, 0, msaaBuffer.textureWidth, msaaBuffer.textureHeight, 0, 0, msaaBuffer.textureWidth,
                msaaBuffer.textureHeight, GL30C.GL_COLOR_BUFFER_BIT, GL30C.GL_LINEAR);
